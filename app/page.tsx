        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-3">
            <motion.button
              ...
              className="px-2 py-2 md:px-4 bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold rounded-lg shadow-md transition-all"
            >
          ...
          <button
            ...
            title="Logout"
            className="p-2 text-gray-400 hover:text-orange-400 hover:bg-gray-800 rounded-lg transition-all"
          >
          ...
          >
            ...
            >
              ...
              <button
                ...
                className="mt-4 w-full bg-gray-800 hover:bg-gray-700 text-gray-200 text-xs font-semibold py-2 px-4 rounded-lg border border-gray-700 transition-all shadow-lg"
              >
                Tutup
              </button>
            </motion.div>
